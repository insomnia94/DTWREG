...
class DataLoader(Loader):
    ...
    def getBatch(self, split, opt):
        ...
        for sent_id in img_sent_ids:
            ...
            sub_wordid = sent_sub_wordid[unicode(sent_id)]
            ...
            sub_classwordid = sent_sub_classwordid[unicode(sent_id)]
            ...
            obj_wordid = sent_obj_wordid[unicode(sent_id)]
            ...
            rel_wordid = sent_rel_wordid[unicode(sent_id)]
